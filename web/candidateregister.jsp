...
<title>
    Online Pooling : CANDIDATE REGISTER
    ...
    <header id="top">
        ...
        <nav id="mainnav">
            <ul>
                ...
                <li><a href="candidatelogin.jsp"class="thispage">Candidate Login</a></li>
...
<center>
    <div>
        ...
        <form method="POST" action="canres">
            <table align="center">
                ...
                <tr><td> Age   </td><td><input type="number" name="age" placeholder="age"  required/><br><br></td></tr>

                <tr><td>Enter Promise  </td><td><textarea rows="3" name="promise" required ></textarea></td></tr>  
                ...
                <tr>
                    <td>Upload Election Manifesto</td>
                    <td><input type="file" name="election_manifesto"/><br><br></td>
                </tr>
            </table>
            <center>
