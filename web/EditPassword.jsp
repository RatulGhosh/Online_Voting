        ...
        <div>
            <form method="POST" action="save_password">
                <table align="center"><br>
                    ...
                    <tr><td>Old Password   </td><td><input type="password" name="opass"  placeholder="opass" required/><br><br></td></tr>

                    <tr><td>New Password   </td><td><input type="password" name="npass" id="password" placeholder="npass" oninput="checkSize();" required/><br><br></td></tr>
